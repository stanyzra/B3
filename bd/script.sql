...
CREATE TABLE `empresa` (
  ...
  `categoria` varchar(200) COLLATE utf8_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `empresa` (`id_empresa`, `nome`, `CEP`, `cidade`, `estado`, `emailEmpresa`, `categoria`) VALUES
(18, 'suable', '4814856', 'PVI', 'PR', 'spoakds@hotmail.com', 'console');
